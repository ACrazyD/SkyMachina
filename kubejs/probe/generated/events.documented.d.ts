...
* The event is **not** cancellable.
*/
declare function onEvent(name: "tags.byg.villager_trades_item_listing", handler: (event: any<any>) => void);
/**
...
* The event is **not** cancellable.
*/
declare function onEvent(name: "tags.byg.blending_function", handler: (event: any<any>) => void);
/**
...
* The event is **not** cancellable.
*/
declare function onEvent(name: "tags.enhancedcelestials.lunar_event_client", handler: (event: any<any>) => void);
/**
* Fired when you need to add, change tags of things.
*
* However, due to the type erasure of Java, Probe can not determine what
...
* The event is **not** cancellable.
*/
declare function onEvent(name: "tags.enhancedcelestials.lunar_event", handler: (event: any<any>) => void);
/**
