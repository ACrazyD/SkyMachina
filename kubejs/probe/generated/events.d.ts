...
declare function onForgeEvent(name: "muramasa.antimatter.event.AntimatterProvidersEvent", handler: (event: Internal.AntimatterProvidersEvent) => void);
...
declare function onForgeEvent(name: "muramasa.antimatter.event.AntimatterWorldGenEvent", handler: (event: Internal.AntimatterWorldGenEvent) => void);
...
declare function onForgeEvent(name: "muramasa.antimatter.event.AntimatterCraftingEvent", handler: (event: Internal.AntimatterCraftingEvent) => void);
...
declare function onForgeEvent(name: "muramasa.antimatter.event.AntimatterLoaderEvent", handler: (event: Internal.AntimatterLoaderEvent) => void);
...
declare function onForgeEvent(name: "de.keksuccino.fancymenu.menu.fancy.helper.MenuReloadedEvent", handler: (event: Internal.MenuReloadedEvent) => void);
