...
*/
declare function onEvent(name: "block.trample", handler: (event: Internal.FarmlandTrampleEventJS) => void);
/**
 * 
 * The event fires on: **startup**, **server**.
 * 
...
declare function onForgeEvent(name: "de.keksuccino.drippyloadingscreen.events.WindowResizedEvent", handler: (event: Internal.WindowResizedEvent) => void);
...
declare function onForgeEvent(name: "com.daderpduck.seamless_loading_screen.events.DeleteSaveEvent", handler: (event: Internal.DeleteSaveEvent) => void);
